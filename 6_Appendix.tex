...
\begin{figure*}
    ...
    \centering
    \includegraphics[width=\textwidth]{images/spec_type_vs_dist_Ks}
    
    \caption{The Ks-band equivalent of Fig.~\ref{fig:MS_distances}. As described in Fig.~\ref{fig:MS_distances} the coloured lines represent the apparent magnitude of the major spectral types with increasing distance.
    ...
    When a coloured line crosses below a horizontal line, it means that this type of main sequence star will no longer be detectable by MICADO at the distance where the cross occurs. As a reference the dashed vertical lines show distances to well known astronomical objects.}
